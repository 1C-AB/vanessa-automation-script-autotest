...
И я жду, что в сообщениях пользователю будет подстрока "Не заполнено значение КлючAPI в настройках модуля Wazzup" в течение 20 секунд
	И я вызываю исключение "Ошибка: Не заполнено значение КлючAPI"

И я жду, что в сообщениях пользователю будет подстрока "Возникла ошибка работы с сервисом Wazzup" в течение 30 секунд
	И я вызываю исключение "Ошибка: Возникла ошибка работы с сервисом"
